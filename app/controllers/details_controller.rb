class DetailsController < ApplicationController
    ...
    respond_to do |format|
      if @detail.save
        format.html { redirect_to @detail, notice: "Detail was successfully created." }
         format.html { render :new, status: :success }
  ...
  private
    ...
    def detail_params
      #params.permit(:first_name, :last_name, :email, :phone, :facebook)
      params.require(:detail).permit(:first_name, :last_name, :email, :phone, :facebook)
    end
end
